...
/**
 * 受講生情報の情報を取り扱うサービスです。 受講生の検索や登録・更新処理を行います。
 */
@Service
public class StudentService {
  ...
  /**
   * 受講生詳細検索です。 IDに紐づく受講生任意の情報を取得します。
   *
   * @param id 受講生ID
   * @return　受講生詳細
   */
  ...
  /**
   * 受講生主催の登録を行います。 受講生と受講生コース情報を個別に登録し、受講生コース情報には受講生情報を紐づける値とコース開始日、コース終了日を設定します。
   *
  ...
  public StudentDetail registerStudent(StudentDetail studentDetail) {
    ...
    for (StudentCourse studentsCourse : studentDetail.getStudentCourseList()) {
